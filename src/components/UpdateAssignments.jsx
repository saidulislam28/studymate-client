...
const {title,email, description, marks, thumbnailImageUrl, difficultyLevel, dueDate} = assignment;
...
const handleUpdate = event =>{
  ...
  console.log(title, description, marks, thumbnailImageUrl, difficultyLevel, dueDate);
  ...
  return (
    ...
    <form onSubmit={handleUpdate}>
        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
                <label className="text-gray-700 dark:text-gray-200">Thumbnail Image</label>
                <input
            ...
            <div>
                <label className="text-gray-700 dark:text-gray-200" >Difficulty Level</label>
                <input 
